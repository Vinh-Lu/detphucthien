...
if ( !is_admin() ) {
   ...
   wp_enqueue_script( 'ResizeSensor', DIGIQOLE_JS . '/ResizeSensor.js', array( 'jquery' ), DIGIQOLE_VERSION, true );
   wp_enqueue_script( 'theia-sticky-sidebar', DIGIQOLE_JS . '/theia-sticky-sidebar.js', array( 'jquery' ), DIGIQOLE_VERSION, true );
